...
namespace Urho3D
{
    ...
    const MaterialInspectorWidget::PropertyDesc MaterialInspectorWidget::vertexDefinesProperty{
        ...
        {
            return Variant{ material->GetVertexShaderDefines() };
        },
        []( Material* material, const Variant& value )
        {
            material->SetVertexShaderDefines( value.GetString() );
        },
    ...
    const MaterialInspectorWidget::PropertyDesc MaterialInspectorWidget::pixelDefinesProperty{
        ...
        []( const Material* material )
        {
            return Variant{ material->GetPixelShaderDefines() };
        },
        []( Material* material, const Variant& value )
        {
            material->SetPixelShaderDefines( value.GetString() );
        },
    ...
    const ea::vector< MaterialInspectorWidget::PropertyDesc > MaterialInspectorWidget::properties{
        {
            ...
            []( const Material* material )
            {
                return Variant{ static_cast< int >( material->GetCullMode() ) };
            },
            []( Material* material, const Variant& value )
            {
                material->SetCullMode( static_cast< CullMode >( value.GetInt() ) );
            },
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ static_cast< int >( material->GetShadowCullMode() ) };
            },
            []( Material* material, const Variant& value )
            {
                material->SetShadowCullMode( static_cast< CullMode >( value.GetInt() ) );
            },
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ static_cast< int >( material->GetFillMode() ) };
            },
            []( Material* material, const Variant& value )
            {
                material->SetFillMode( static_cast< FillMode >( value.GetInt() ) );
            },
...

        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetAlphaToCoverage() };
            },
            []( Material* material, const Variant& value )
            {
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetLineAntiAlias() };
            },
            []( Material* material, const Variant& value )
            {
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ static_cast< int >( material->GetRenderOrder() ) };
            },
            []( Material* material, const Variant& value )
            {
                material->SetRenderOrder( static_cast< unsigned char >( value.GetInt() ) );
            },
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetOcclusion() };
            },
            []( Material* material, const Variant& value )
            {
...

        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetDepthBias().constantBias_ };
            },
            []( Material* material, const Variant& value )
            {
                auto temp          = material->GetDepthBias();
                temp.constantBias_ = value.GetFloat();
                material->SetDepthBias( temp );
            },
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetDepthBias().slopeScaledBias_ };
            },
            []( Material* material, const Variant& value )
            {
                auto temp             = material->GetDepthBias();
                temp.slopeScaledBias_ = value.GetFloat();
                material->SetDepthBias( temp );
            },
        ...
        },
        {
            ...
            []( const Material* material )
            {
                return Variant{ material->GetDepthBias().normalOffset_ };
            },
            []( Material* material, const Variant& value )
            {
                auto temp          = material->GetDepthBias();
                temp.normalOffset_ = value.GetFloat();
                material->SetDepthBias( temp );
            },
            "You probably don't want to change this",
        },
    ...
    MaterialInspectorWidget::MaterialInspectorWidget( Context* context, const MaterialVector& materials ) : Object( context ), materials_( materials ), previewScene_( MakeShared< Scene >( context ) ), previewWidget_( MakeShared< SceneRendererToTexture >( previewScene_ ) )
    {
    ...
    void MaterialInspectorWidget::UpdateTechniques( const ea::string& path )
    {
        ...
        ea::sort( sortedTechniques_.begin(), sortedTechniques_.end(),
                  []( const TechniqueDescPtr& lhs, const TechniqueDescPtr& rhs )
                  {
                      return *lhs < *rhs;
                  } );
    ...
    void MaterialInspectorWidget::RenderPreview()
    {
        ...
        workQueue->PostDelayedTaskForMainThread(
            [ widget = previewWidget_ ]
            {
    ...
    void MaterialInspectorWidget::RenderTechniques()
    {
        ...
        const bool isUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                             [ & ]( Material* material )
                                             {
                                                 return sortedTechniqueEntries_ != material->GetTechniques();
                                             } );
    ...
    {
        return resourceName.starts_with( "Techniques/PBR/" ) || resourceName.starts_with( "Techniques/Diff" ) || resourceName.starts_with( "Techniques/NoTexture" ) || resourceName == "Techniques/BasicVColUnlitAlpha.xml" || resourceName == "Techniques/TerrainBlend.xml"
               || resourceName == "Techniques/VegetationDiff.xml" || resourceName == "Techniques/VegetationDiffUnlit.xml" || resourceName == "Techniques/Water.xml";
    }
    ...
    void MaterialInspectorWidget::RenderShaderDefines()
    {
        ...
        const bool vertexDefinesUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                                        [ & ]( const Material* material )
                                                        {
                                                            return vertexDefines != material->GetVertexShaderDefines();
                                                        } );
        ...
        const bool pixelDefinesUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                                       [ & ]( const Material* material )
                                                       {
                                                           return pixelDefines != material->GetPixelShaderDefines();
                                                       } );
        ...
        // Render widget for vertex defines
        {
            ...
            Widgets::ItemLabel( vertexDefinesProperty.name_, Widgets::GetItemLabelColor( vertexDefinesUndefined, vertexDefines.GetString().empty() ) );
            if ( ui::IsItemHovered() )
                ui::SetTooltip( "%s", vertexDefinesProperty.hint_.c_str() );

            const ColorScopeGuard guardBackgroundColor{ ImGuiCol_FrameBg, Widgets::GetItemBackgroundColor( vertexDefinesUndefined ), vertexDefinesUndefined };
        ...
        // Render widget for pixel defines
        {
            ...
            Widgets::ItemLabel( pixelDefinesProperty.name_, Widgets::GetItemLabelColor( pixelDefinesUndefined, pixelDefines.GetString().empty() ) );
            if ( ui::IsItemHovered() )
                ui::SetTooltip( "%s", pixelDefinesProperty.hint_.c_str() );

            const ColorScopeGuard guardBackgroundColor{ ImGuiCol_FrameBg, Widgets::GetItemBackgroundColor( pixelDefinesUndefined ), pixelDefinesUndefined };
    ...
    void MaterialInspectorWidget::RenderProperty( const PropertyDesc& desc )
    {
        ...
        const bool isUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                             [ & ]( const Material* material )
                                             {
                                                 return value != desc.getter_( material );
                                             } );
    ...
    void MaterialInspectorWidget::RenderTextureUnit( const TextureUnitDesc& desc )
    {
        ...
        const bool isUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                             [ & ]( const Material* material )
                                             {
                                                 return material->GetTexture( desc.name_ ) != texture;
                                             } );
    ...
    {
        const auto isSame = [ & ]( const TextureUnitDesc& desc )
        {
            return desc.name_ == unit;
        };
    ...
    void MaterialInspectorWidget::RenderCustomTextureUnit( const ea::string& unit )
    {
        ...
        const bool isUndefined = ea::any_of( materials_.begin() + 1, materials_.end(),
                                             [ & ]( const Material* material )
                                             {
                                                 return material->GetTexture( unit ) != texture;
                                             } );
    ...
    void MaterialInspectorWidget::RenderShaderParameter( const ea::string& name )
    {
        ...
        const auto materialIter = ea::find_if( materials_.begin(), materials_.end(),
                                               [ & ]( const Material* material )
                                               {
                                                   return ! material->GetShaderParameter( name ).IsEmpty();
                                               } );
        ...
        const bool isUndefined = ea::any_of( materials_.begin(), materials_.end(),
                                             [ & ]( const Material* material )
                                             {
                                                 return material->GetShaderParameter( name ) != value;
                                             } );
